...
public class DealsDataCollector {
	...
	public void recordTransaction(individual.Customer customer){
		...
		System.out.println("Watchee called : last transaction changed");

		if(t.getTransactionType() == TransactionType.Broker //getWhoseDealUsed() != t.getCustomerID()
				){
			++BrokeredDealsToday;
	...
	@ScheduledMethod(start = Settings.StepsInDay+1, interval = Settings.StepsInDay+1, priority = 10)
