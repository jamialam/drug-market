...
public class Dealer extends Person {
	...
	public void updatePrice() {
		...
		else if(currentTick == (Settings.initialPhase + entryTick ) +( Settings.stepsInDay - (Settings.initialPhase + this.entryTick) % Settings.stepsInDay )){	Summary summary = initializeMeanAndVariance(itr);
...
*/
	...
	public void newDealer() {		
		...
		//		}
	//	this.totalSales += this.salesPerDay;
