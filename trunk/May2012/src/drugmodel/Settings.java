...
import drugmodel.Settings.UpdatePrice;
...
//	public static enum DealerSelection {Random, MyBest, NetworkBest};
	...
	public static enum TransactionType {directDeal, through_Broker};
	...
	public static class DealersParams {  
		...
		private static final int SurplusIntervalInDays = 21;
		...
		public static final double NewDealerInterval = NewDealerIntervalInDays * StepsInDay;
		...
		public static final double PoliceArrestProb = 0.0001;
	...
	public static class CustomerParams {
		...
		public static double MyDealerSelectionProb = 0.8;
		public static double MinshareDealProb = 0.1;
		public static double MaxshareDealProb = 0.1;
		...
		/** Careful - a customer agent uses this SAME interval to evaluate its social links and 
		...
		/*used in dealer evaluation link */
		public static final int LastTransactionToDropLinkInDays = 7;
...
*/
		...
		public static final int NumTriesMakeLink = 3;
